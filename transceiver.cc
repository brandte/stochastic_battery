...
void transceiver::initialize(){
    dead=0;
    power_level("sleep");
    sending_duration =sending_duration_function();
...
void transceiver::handleMessage(cMessage *msg)
{
    if(dead==0){
        ...
        }else if(msg==battery_exhausted||strcmp(msg->getName(),("Battery exhausted"))==0){
            dead=1;
            delete msg;
            EV<< "Battery of the" << getParentModule()->getName() << "is empty";
        }else{
...
double transceiver::sending_duration_function()
{
    ...
    l_message_length=ceil(l_message_length/64)*64;               //extended message length -> modulo 64
